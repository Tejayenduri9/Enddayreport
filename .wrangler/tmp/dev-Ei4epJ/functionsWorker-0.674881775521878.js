...
var require_streamingEventType = __commonJS({
  "../node_modules/svix/dist/api/streamingEventType.js"(exports) {
    ...
    var StreamingEventType = class {
      ...
      static {
        __name2(this, "StreamingEventType");
      }
      constructor(requestCtx) {
        this.requestCtx = requestCtx;
      }
...
var require_webhook = __commonJS({
  "../node_modules/svix/dist/webhook.js"(exports) {
    ...
    Object.defineProperty(exports, "WebhookVerificationError", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return standardwebhooks_2.WebhookVerificationError;
    }, "get") });
    var Webhook2 = class {
      static {
        __name(this, "Webhook2");
      }
      static {
        __name2(this, "Webhook");
      }
...
var require_models = __commonJS({
  "../node_modules/svix/dist/models/index.js"(exports) {
    ...
    var connectorProduct_1 = require_connectorProduct();
    Object.defineProperty(exports, "ConnectorProduct", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
    ...
    var sinkStatus_1 = require_sinkStatus();
    Object.defineProperty(exports, "SinkStatus", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return sinkStatus_1.SinkStatus;
    }, "get") });
    var sinkStatusIn_1 = require_sinkStatusIn();
    Object.defineProperty(exports, "SinkStatusIn", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
...
async function onRequest(context) {
  ...
  try {
    ...
    const fallbackEmails = context.env.OWNER_EMAILS ? context.env.OWNER_EMAILS.split(",").map((e) => e.trim()).filter(Boolean) : [];
    const emails = ownerEmails ? ownerEmails.split(",").map((e) => e.trim()).filter(Boolean) : [];
    const allEmails = [.../* @__PURE__ */ new Set([...emails, ...fallbackEmails])];
    console.log("\u{1F4E7} Sending to:", allEmails);
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 500px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
          <h2 style="color: #1a3d2b;">\u{1F4CB} Report Feedback</h2>
